...
<p>Critical AI researchers have long argued that "AI" is not a technological term, but rather a marketing term wielded by technocapitalists to conjure visions of near-magical capabilities. Strip away the “hype” and what emerges is that all-too-familiar capitalist system that disproportionately targets minoritized communities across the globe. Consider the traumatized and underpaid data workers in Kenya, the unsafe extraction of cobalt from the Democratic Republic of Congo, the uncompensated harvesting of artists' data affecting their livelihoods, or water scarcity in Chile caused by the millions of gallons of fresh water consumed by data centers. To dissect the capitalist mechanisms through an intersectional lens, I turn to a world closely tied to my own experience-Black hair braiding.
</p>
<p className="body-text">
            Often celebrated as an art form, hair braiding is, however, driven by ethnomathematical principles. Translation determines the spacing between rows, tessellation forms geometric patterns on the scalp, rotation curves the braid’s path, reflection ensures symmetry, and dilation controls expansion/contraction.
